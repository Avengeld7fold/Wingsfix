...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{!! asset('assets/css/color1.css') !!}" id="colors">
                                ...
                                <div id="site-logo" class="clearfix">
                                    <div class="bg-color-logo wrap-logo m-0">
                                        <div id="site-log-inner" class="wrap-inner-logo">
                                            <a class="title-logo" href="/"><img
                                                    src="assets/img/logo/logo-blue.png" class="padr-10 "
                                                    alt="images">WingsFix</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <nav id="main-nav" class="main-nav">
                                    <ul id="menu-primary-menu" class="menu">
                                        ...
                                        <li class="menu-item menu-item-has-children">
                                            <a href="aboutus.html" class="after-sub">Layanan Service</a>
                                            <!-- <ul class="sub-menu">
                                                <li class="menu-item"><a href="aboutus.html" class="after-sub">About
                                                        Us</a></li>
                                        ...
                                        <li class="menu-item menu-item-has-children">
                                            <a href="#" class="after-sub">Hubungi Kami</a>
                                            <!-- <ul class="sub-menu">
                            ...
                            <div class="col-md-3 des-mar">
                                <div class="wrap-right-bar">
                                    <div class="right-bar bg-color-bar">
                                        ...
                                        <ul class="p-0">
                                            <li class="call-us"> <a href="services.html">Hubungi Kami</a> </li>
                                            <li class="number"><a href="tel:0123456">081293894120</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row m-0 wrap-height">
                                            ...
                                            <div class="col-md-7 col-right-banner">
                                                <div class="wrap-banner-right">
                                                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-interval="4000" data-bs-ride="carousel">
                                                        <div class="carousel-inner">
                                                          <div class="carousel-item active">
                                                            <img src="assets/img/banner/laptop.png" class="d-block w-100" alt="...">
                                                          </div>
                                                          <div class="carousel-item">
                                                            <img src="assets/img/banner/hp.png" class="d-block w-100" alt="...">
                                                          </div>
                                                          <div class="carousel-item">
                                                            <img src="assets/img/banner/pc.png" class="d-block w-100" alt="...">
                                                          </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="wrap-banner-title wow fadeInUp" data-wow-duration="1s"
                                                ...
                                                <div class="frame-title">
                                                    <h5 class="title-heading small">WingsFix</h5>
                                                    <h1 class="title-heading big">Specialist Smartphone & Computer Repair</h1>
                                                    <h6 class="title-small">Selalu ada cara perbaikan yang tepat untuk setiap kerusakan, dengan analisa yang akurat dan alat yang menunjang perbaikan serta teknisi yanng profesional bersama WingsFix </h6>
                                                </div>
                                            ...
                                            <div class="col-md-12 pr-0 wow fadeInDown center">
                                                <div class="themesflat-headings style-1 text-center clearfix">
                                                    <div class="wrap-inner-big">
                                                        <h2 class="title-heading big">Kenapa Harus Service Di WingsFix?</h2>
                                                    </div>
                                                    <div class="wrap-inner-small">
                                                        <h2 class="title-heading small">Berikut beberapa alasan dan benefit yang akan anda dapatkan jika anda memilih WingsFix sebagai tempat untuk memperbaiki perangkat Apple Mac anda.</h2>
                                                    </div>
                                                </div>
                                                <!-- /.row -->
                                            </div>
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="title">
                                                                            <h4 class="title-heading big"><a
                                                                                    href="aboutus.html">Prioritas Kecepatan & Ketepatan</a>
                                                                            </h4>
                                                                            <p class="title-small mb-0">Kami sangat memahami betapa pentingnya perangkat ponsel. Dengan dukungan teknisi handal dan alat perbaikan profesional waktu perbaikan handphone & laptop akan lebih cepat.</p>
                                                                        </div>
                                                                        <div class="frame-button">
                                                                            <a href="aboutus.html"
                                                            ...
                                                            <div class="text-wrap">
                                                                <div class="row m-0">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="title">
                                                                            <h4 class="title-heading big"><a
                                                                                    href="aboutus.html">Biaya Lebih Hemat & Bergaransi</a></h4>
                                                                            <p class="title-small mb-0">Dengan menggunakan jasa service WingsFix kamu dapat menghemat banyak biaya dan tetap mendapatkan hasil perbaikan handphone & laptop yang maksimal dengan suku cadang handal.</p>
                                                                        </div>
                                                                        <div class="frame-button">
                                                                            <a href="aboutus.html"
                                                                                class="fixmo-button  btn-font-1">
                                                                ...
                                                                <div class="row m-0">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="title owl-3">
                                                                            <h4 class="title-heading big"><a
                                                                                    href="aboutus.html">Customer Support Cepat & Tanggap</a></h4>
                                                                            <p class="title-small mb-0">Kami juga peduli apa yang terjadi setelah perbaikan. Jika kamu memiliki kendala setelah menggunakan layanan perbaikan WingsFix. Tim customer support Kami selalu siap membantu.</p>
                                                                        </div>
                                                                        <div class="frame-button">
                                                                            <a href="aboutus.html"
                                                                                class="fixmo-button  btn-font-1">
                                            ...
                                            <div class="wrap-about-title wow fadeInRight">
                                                <div class="frame-title">
                                                    <h2 class="title-heading big text-white">We Fix All Devices All
                                                        Problems</h2>
                                                    <h6 class="title-small text-white">Sed ut perspiciatis unde omnis
                                                        ...
                                                        <div class="device-frame">
                                                            <div class="row-title">
                                                                <a href="services.html">
                                                                    <h3 class="title-heading big text-white">Quality
                                                                        Control System</h3>
                                                                </a>
                                                                <p class="title-small text-white">Lorem ipsum dolor sit
                                                                    amet, consetetur sadipscing elitr, sed diam nonumy
                                                                </p>
                                                            </div>
                                                            <div class="row-title">
                                                                <a href="services.html">
                                                                    <h3 class="title-heading big text-white">Highly
                                ...
                                <section class="flat-row flat-about2">
                                    <div class="container">
                                        <div class="themesflat-headings style-1 text-center clearfix">
                                            ...
                                            <div class="wrap-inner-big">
                                                <h2 class="title-heading big mart-22">We Fix All Devices, All Problems
                                                </h2>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="wrap-title">
                                                                                ...
                                                                                <h2 class="title-heading big">Profit
                                                                                    Planning</h2>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="wrap-title">
                                                                                ...
                                                                                <h2 class="title-heading big">Get your
                                                                                    repair Iphone</h2>
                                                                                <p class="title-small">Lorem ipsum dolor
                                                                                    sit amet, consetetur sadipscing
                                                                                    elitr, sed diam nonumy eirmod tempor
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 p-0">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="wrap-inner-big">
                                                            <h2 class="title-heading big">Tahapan Service Di WingsFix</h2>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="themesflat-row gutter-30 clearfix">
                                                <div class="col span_1_of_4 padding-col">
                                                    <div
                                                        ...
                                                        <div class="text-wrap">
                                                            <h5 class="heading"><a href="services.html">Step 1.Proses Pengecekan</a></h5>
                                                            <p class="sub-heading">Proses Pengecekan
Pada tahap pertama ini, unit Anda akan dicek secara keseluruhan, Untuk memastikan kerusakan yang terjadi.</p>
                                                        </div>
                                                    </div>
                                                    <!-- /.themesflat-icon-box -->
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="text-wrap">
                                                            <h5 class="heading"><a href="services.html">Step 3.Proses Perbaikan</a></h5>
                                                            <p class="sub-heading">Jika customer setuju, maka unit akan langsung diperbaiki dan melewati tahap tes running, untuk memastikan unit sudah kembali normal.</p>
                                                        </div>
                                                    </div>
                                                    <!-- /.themesflat-icon-box -->
                                                </div>
                                                ...
                                                <div class="col span_1_of_4">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="text-wrap">
                                                            <h5 class="heading"><a href="services.html">Step 2.Proses Report.</a></h5>
                                                            <p class="sub-heading">Pada tahap kedua, Teknisi akan menyampaikan diagnosa kerusakan kepada customer support yang bersangkutan untuk disampaikan kembali kepada customer.</p>
                                                        </div>
                                                    </div>
                                                    <!-- /.themesflat-icon-box -->
                                                    <div class="themesflat-spacer clearfix" data-desktop="24"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="text-wrap">
                                                            <h5 class="heading"><a href="services.html">Step 4.Get Your
                                                                    Device</a></h5>
                                                            <p class="sub-heading">Setelah perbaikan dan test running selesai, team kami akan menghubungi kamu untuk penjadwalan pengambilan device.</p>
                                                        </div>
                                                    </div>
                                                    <!-- /.themesflat-icon-box -->
                                                </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="wrap-testimonials staff-1">
                                                                        ...
                                                                        <div class="testimonials-sub-title">
                                                                            <p class="text-white">Iphone X saya matot, uda muter2 ke toko laen pada ga sanggup tapi di toko ini juga bilang sulit tapi mau diusahakan.. singkat cerita hp saya tinggal 2 hari dan tiba" di tlpn ternyata hp saya bisa nyala lagi..</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="wrap-testimonials">
                                                                        <div class="testimonials-item">
                                                                            ...
                                                                            <div class="testimonials-heading padl-30">
                                                                                <p class="heading-name text-white">Muhammad
                                                                                    Hasan</p>
                                                                                <p class="heading-woker text-white">
                                                                                    Jakarta Barat</p>
                                                                            </div>
                                                                        ...
                                                                        <div class="testimonials-sub-title">
                                                                            <p class="text-white">Layanan ramah, service bisa ditunggu, Service S10+ mati kemasukan air alhamdulillah Handphone dan data selamat. Sebelumnya cek ke ***** center di suruh ganti unit (Estimasi harga 2x lipat dan data hilang)</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <!-- /themesflat-testimonials -->
                                ...
                                <div class="col-md-4">
                                    <div class="our-inner pl-style-2 bg-style-2">
                                        ...
                                        <ul class="list-info">
                                            ...
                                            <li class="sub-title"><a href="mailto:name@website.com">name@website.com</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="our-inner pl-style-3 bg-style-1">
                                        ...
                                        <ul class="list-info">
                                            ...
                                            <li class="sub-title"><a href="contact.html">2 St, Loskia sripur,
                                                    amukara.</a></li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="wrap-about">
                                        <div class="logo-footer">
                                            <a class="title-logo" href="services.html"><img
                                                    ...
                                                    alt="images">Fixmo</a>
                                            <p class="title-small sub-logo">WingsFix adalah Jasa Service Hp Terpercaya yang Berbasis di Tangerang untuk Berbagai Perangkat Portable Meliputi; iPhone, iPad, MacBook, dan Laptop. Kami Menawarkan Produk Perbaikan dengan Kualitas Terbaik dan Harga Terjangkau.</p>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="left-footer-end">
                                            <p class="title-small"><a href="/">© Themesflat &nbsp;2021</a> |
    ...
    <script type="text/javascript" src="{{asset('assets/js/owl.carousel2.thumbs.js')}}"></script>
